...
export const TEAM_INFO = [
  { name: GARRIN_NAME, tag: GARRIN_TAG },
  { name: GARRIN_SMURF_NAME, tag: GARRIN_SMURF_TAG },
  { name: JAC_NAME, tag: JAC_TAG },
  ...
  { name: SION_NAME, tag: SION_TAG },
  { name: SOPHIE_NAME, tag: SOPHIE_TAG }
]
